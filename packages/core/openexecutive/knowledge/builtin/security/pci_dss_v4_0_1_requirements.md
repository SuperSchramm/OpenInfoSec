...
- **Requirement 11.3.1.2 (authenticated internal scans).** Internal vulnerability scans of in-scope systems must use authenticated scanning where the systems can support it.
